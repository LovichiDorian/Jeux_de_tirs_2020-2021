package com.isartdigital.utils.sound 
{
	...
	public class SoundFX extends EventDispatcher
	{
		 ...
		 */
		protected static var framer:Sprite = new Sprite();
		 ...
		 * liste des sons
		 */
		protected static var _list:Vector.<SoundFX> = new Vector.<SoundFX>(); 
		
        public static function get list():Vector.<SoundFX> {
            return _list;
        }
		...
		public function SoundFX(pSound:Sound, pVolume:Number) 
		{
			sound  		   = pSound;
		...
		public static function set mainVolume (pVolume:Number): void {
			...
			for each (var lSFX:SoundFX in _list) 
		...
		public function destroy (): void {
			...
			_list.splice(_list.indexOf(this), 1);
		}
